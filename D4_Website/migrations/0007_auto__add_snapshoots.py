...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SnapShoots'
        db.create_table(u'D4_Website_snapshoots', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('snapshoot', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['D4_Website.Projects'])),
        ))
        db.send_create_signal(u'D4_Website', ['SnapShoots'])


    def backwards(self, orm):
        # Deleting model 'SnapShoots'
        db.delete_table(u'D4_Website_snapshoots')
    ...
    models = {
        ...
        u'D4_Website.snapshoots': {
            ...
            'snapshoot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'})
        },
