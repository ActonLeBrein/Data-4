...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SnapShoots.snapshoot'
        db.delete_column(u'D4_Website_snapshoots', 'snapshoot')

        # Adding field 'SnapShoots.snapshoot_img'
        db.add_column(u'D4_Website_snapshoots', 'snapshoot_img',
                      self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SnapShoots.snapshoot'
        db.add_column(u'D4_Website_snapshoots', 'snapshoot',
                      self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100),
                      keep_default=False)

        # Deleting field 'SnapShoots.snapshoot_img'
        db.delete_column(u'D4_Website_snapshoots', 'snapshoot_img')
