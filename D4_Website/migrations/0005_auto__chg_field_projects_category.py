...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Projects.category'
        db.alter_column(u'D4_Website_projects', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['D4_Website.Category']))

    def backwards(self, orm):

        # Changing field 'Projects.category'
        db.alter_column(u'D4_Website_projects', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['D4_Website.Category'], null=True))
