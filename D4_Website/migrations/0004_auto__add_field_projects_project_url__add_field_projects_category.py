...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Projects.project_url'
        db.add_column(u'D4_Website_projects', 'project_url',
                      self.gf('django.db.models.fields.URLField')(max_length=1000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Projects.category'
        db.add_column(u'D4_Website_projects', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['D4_Website.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Projects.project_url'
        db.delete_column(u'D4_Website_projects', 'project_url')

        # Deleting field 'Projects.category'
        db.delete_column(u'D4_Website_projects', 'category_id')
    ...
    models = {
        ...
        u'D4_Website.projects': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['D4_Website.Category']", 'null': 'True', 'blank': 'True'}),
